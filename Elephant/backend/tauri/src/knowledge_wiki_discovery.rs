...
pub use engine::{tauri_knowledge_wiki_embedding_map, SemanticWikiCandidate};
...
// Keep the public Rust path and IPC command name stable. The command wrapper macro is
// generated by the engine function, whose signature matches this persisted facade.
pub use tauri_knowledge_wiki_semantic_discover_persisted as tauri_knowledge_wiki_semantic_discover;
