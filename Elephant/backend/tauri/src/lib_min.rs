...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            vault_binary_commands::tauri_vault_read_binary,
            vault_binary_commands::tauri_vault_write_binary,
            vault_binary_commands::tauri_vault_ensure_dir,
            vault_binary_commands::tauri_vault_remove_path,
            vault_binary_commands::tauri_vault_rename_path,
