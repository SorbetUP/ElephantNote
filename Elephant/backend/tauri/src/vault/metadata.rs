...
pub fn initialize_vault(vault_root: &str) -> R<Value> {
    ...
    write_json_if_missing(
        ...
        json!({ "version": 1, "queue": [], "lastRunAt": null }),
    )?;
