...
export const getRecommendedSetupModels = (catalog = [], runtime = AI_SETUP_RUNTIME_NODE_LLAMA_CPP) => {
  const ids = AI_SETUP_RECOMMENDED_IDS[runtime] || AI_SETUP_RECOMMENDED_IDS[AI_SETUP_RUNTIME_NODE_LLAMA_CPP]
...
export const isRunnableSetupModel = (model = {}) => {
  if (model.provider === AI_SETUP_RUNTIME_NODE_LLAMA_CPP) {
