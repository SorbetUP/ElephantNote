...
export const ELEPHANTNOTE_API_DOMAINS = Object.freeze({
  ...
  aiRuntime: Object.freeze([
    ...
    action('AI_CONFIG_TEST', 'ai.config.test', schema.object({ preset: optionalString, name: optionalString, provider: optionalString, transport: optionalString, endpoint: optionalString, model: optionalString, apiKey: optionalString, codexLinkEnabled: optionalBoolean })),
