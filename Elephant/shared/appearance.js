...
export const ELEPHANTNOTE_THEME_TOKENS = {
  ...
  'apple-light': createThemeTokens({
    ...
    danger: '#ff3b30',
    shadow: '0 28px 80px rgba(60, 60, 67, 0.16)',
    codeBg: '#f0f0f3'
  }),
  ...
  'graphite-light': createThemeTokens({
    ...
    primaryRgb: [82, 82, 91],
    danger: '#dc2626',
    shadow: '0 22px 70px rgba(39, 39, 42, 0.14)',
    codeBg: '#ededf0'
  }),
  'nord-dark': createThemeTokens({
    ...
    danger: '#bf616a',
    shadow: '0 22px 58px rgba(16, 22, 31, 0.32)',
    codeBg: '#343b49'
  }),
  'nord-light': createThemeTokens({
    ...
    danger: '#bf616a',
    shadow: '0 24px 72px rgba(46, 52, 64, 0.15)',
    codeBg: '#e5e9f0'
  }),
  'solar-dark': createThemeTokens({
    ...
    danger: '#fb7185',
    shadow: '0 22px 60px rgba(20, 12, 6, 0.38)',
    codeBg: '#241f1c'
  }),
  'solar-light': createThemeTokens({
    ...
    danger: '#dc2626',
    shadow: '0 24px 72px rgba(124, 79, 45, 0.16)',
    codeBg: '#ffedd5'
  }),
  'forest-dark': createThemeTokens({
    ...
    danger: '#fb7185',
    shadow: '0 22px 62px rgba(4, 18, 10, 0.4)',
    codeBg: '#142019'
  }),
  'forest-light': createThemeTokens({
    ...
    danger: '#dc2626',
    shadow: '0 24px 70px rgba(32, 70, 40, 0.15)',
    codeBg: '#e7efe2'
  })
}
...
export const getThemeFamily = (theme) => THEME_META_BY_ID[normalizeThemeId(theme)]?.family || ELEPHANTNOTE_THEME_FAMILIES[0]
...
export const getThemeVariant = (familyId, mode) => {
  const family = ELEPHANTNOTE_THEME_FAMILIES.find((item) => item.id === familyId) || ELEPHANTNOTE_THEME_FAMILIES[0]
