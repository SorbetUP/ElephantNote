                ...
                <div className="flex items-center justify-center h-[24px]">
                  <button
                    ...
                    className={`flex items-center justify-center !transition-all ${
                      isPc
                        ? 'group-hover:opacity-100 opacity-0 w-0 h-0 group-hover:w-[24px] group-hover:h-[24px]'
                        : 'opacity-100 w-[36px] h-[36px]'
                    }`}
                    onClick={(e) => {
                      e.stopPropagation();
                      handleExpand(e);
                    }}
                    aria-label={isExpanded ? 'Collapse tag group' : 'Expand tag group'}
                  >
                    {isExpanded ? (
                  ...
                  <div className={`${isPc ? 'group-hover:opacity-0 opacity-100 w-[24px] group-hover:w-0' : ''} !transition-all`}>
                ...
                <DropdownTrigger>
                  <div
                    className={`ml-auto !transition-all ${
                      isPc ? 'group-hover:opacity-100 opacity-0 group-hover:translate-x-0 translate-x-2' : 'opacity-100 translate-x-0'
                    }`}
                  >
