...
| Old physical catalogue merge attempt, PR #82 | Direct Git merge of legacy catalogue history | **Closed unmerged.** It conflicted structurally with the dedicated `Elephant-Addons/official/**` layout; its guarantees are covered by the addon repository contracts instead. |
