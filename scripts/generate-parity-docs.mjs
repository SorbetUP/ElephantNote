...
const features = [
  ...
  },
  {
    ...
    files: ['src/renderer/src/main.js', 'src/renderer/src/pages/app.vue', 'src/renderer/src/platform/runtimeBridge.js', 'Elephant/front/app/components/shell/AppShell.vue'],
    verbs: ['mount', 'assert', 'log', 'detect', 'surface', 'recover', 'snapshot', 'compare', 'route', 'bootstrap']
  },
  {
    ...
    files: ['src/renderer/src/platform/runtimeBridge.js', 'src/renderer/src/platform/pathFacade.js', 'src/preload/**', 'src-tauri/src/**'],
    verbs: ['normalize', 'polyfill', 'bridge', 'assert', 'document', 'compare', 'mock', 'call', 'guard', 'trace']
  },
  {
    ...
    files: ['Elephant/front/app/stores/vaultStore.js', 'Elephant/front/app/services/elephantnoteClient.js', 'Elephant/back/app/vaults/**'],
    verbs: ['load', 'select', 'persist', 'hydrate', 'filter', 'open', 'refresh', 'recover', 'migrate', 'verify']
  },
  {
    ...
    files: ['Elephant/front/app/utils/noteCardView.js', 'Elephant/front/app/components/**/Note*.vue', 'Elephant/shared/markdownDocument.js'],
    verbs: ['strip', 'render', 'truncate', 'preview', 'resolve', 'style', 'sort', 'filter', 'refresh', 'snapshot']
  },
  {
    ...
    files: ['Elephant/front/app/components/editor/NoteEditorHost.vue', 'Elephant/front/app/components/editor/NoteEditorTopBar.vue', 'src/renderer/src/muya/**'],
    verbs: ['open', 'edit', 'save', 'reopen', 'sync', 'index', 'render', 'diff', 'persist', 'recover']
  },
  {
    ...
    files: ['Elephant/shared/markdownDocument.js', 'Elephant/front/app/utils/noteCardView.js', 'Elephant/front/app/stores/vaultStore.js'],
    verbs: ['resolve', 'rename', 'sync', 'prioritize', 'fallback', 'refresh', 'compare', 'migrate', 'normalize', 'assert']
  },
  {
    ...
    files: ['Elephant/front/app/stores/vaultStore.js', 'Elephant/front/app/components/editor/NoteEditorHost.vue', 'Elephant/front/app/components/**/Note*.vue'],
    verbs: ['restore', 'alias', 'toggle', 'persist', 'migrate', 'dedupe', 'render', 'sort', 'log', 'test']
  },
  {
    ...
    files: ['Elephant/front/app/components/editor/NoteTagForm.vue', 'Elephant/front/app/components/editor/NoteEditorTopBar.vue', 'Elephant/shared/markdownDocument.js'],
    verbs: ['normalize', 'submit', 'validate', 'dedupe', 'escape', 'write', 'preserve', 'remove', 'log', 'recover']
  },
  {
    ...
    files: ['Elephant/front/app/stores/searchStore.js', 'Elephant/front/app/components/search/**', 'Elephant/front/app/stores/vaultStore.js'],
    verbs: ['index', 'query', 'rank', 'highlight', 'open', 'update', 'delete', 'refresh', 'debounce', 'log']
  },
  {
    ...
    files: ['Elephant/front/app/stores/vaultStore.js', 'Elephant/back/app/vaults/**', 'src-tauri/src/**'],
    verbs: ['create', 'rename', 'move', 'delete', 'refresh', 'migrate', 'reject', 'confirm', 'persist', 'reload']
  },
  {
    ...
    files: ['Elephant/front/app/stores/vaultStore.js', 'Elephant/shared/**', 'Elephant/back/app/vaults/**'],
    verbs: ['filter', 'hide', 'expose', 'scope', 'migrate', 'assert', 'exclude', 'include', 'document', 'warn']
  },
  {
    slug: '13-wiki-view',
    title: 'Wiki view',
    ...
    files: ['Elephant/front/app/components/views/WikiView.vue', 'Elephant/front/app/stores/vaultStore.js', 'Elephant/back/app/wiki/**'],
    verbs: ['list', 'open', 'create', 'accept', 'dismiss', 'regenerate', 'filter', 'render', 'log', 'test']
  },
  {
    slug: '14-graph-view',
    title: 'Graph view',
    ...
    files: ['Elephant/front/app/components/views/GraphView.vue', 'Elephant/front/app/stores/vaultStore.js', 'Elephant/front/app/stores/searchStore.js'],
    verbs: ['model', 'count', 'layout', 'focus', 'clamp', 'select', 'preview', 'timeline', 'exclude', 'snapshot']
  },
  {
    ...
    files: ['Elephant/front/app/components/views/ModelsView.vue', 'Elephant/front/app/components/views/modelsViewHelpers.js', 'Elephant/back/app/models/**'],
    verbs: ['search', 'list', 'download', 'cancel', 'uninstall', 'assign', 'persist', 'readme', 'render', 'fallback']
  },
  {
    ...
    files: ['Elephant/front/app/components/settings/**', 'Elephant/front/app/components/shell/SettingsPanel.vue', 'Elephant/front/app/stores/preferencesStore.js'],
    verbs: ['render', 'toggle', 'persist', 'compare', 'snapshot', 'style', 'align', 'validate', 'reset', 'recover']
  },
  {
    ...
    files: ['Elephant/front/app/components/shell/**', 'src/renderer/src/pages/app.vue', 'src-tauri/tauri.conf.json'],
    verbs: ['measure', 'drag', 'click', 'align', 'style', 'compare', 'mask', 'snapshot', 'clamp', 'document']
  },
  {
    slug: '18-chat-layout',
    title: 'Chat layout',
    ...
    files: ['Elephant/front/app/components/chat/**', 'Elephant/front/app/components/editor/NoteEditorHost.vue', 'Elephant/front/app/components/shell/AppShell.vue'],
    verbs: ['open', 'close', 'resize', 'clamp', 'preserve', 'fallback', 'visible', 'persist', 'layout', 'snapshot']
  },
  {
    ...
    files: ['src/renderer/src/muya/**', 'Elephant/front/app/components/editor/**', 'Elephant/front/app/components/rich-blocks/**'],
    verbs: ['trigger', 'filter', 'insert', 'render', 'persist', 'reload', 'fallback', 'mount', 'bridge', 'test']
  },
  {
    ...
    files: ['Elephant/front/app/components/shell/**', 'Elephant/front/app/components/views/**', 'src/renderer/src/pages/app.vue'],
    verbs: ['measure', 'clamp', 'wrap', 'scroll', 'contain', 'hide', 'audit', 'warn', 'snapshot', 'compare']
  },
  {
    ...
    files: ['src/renderer/src/diagnostics/**', 'Elephant/front/app/stores/**', 'src/main/index.js', 'src-tauri/src/**'],
    verbs: ['log', 'forward', 'rate-limit', 'capture', 'serialize', 'copy', 'tag', 'buffer', 'assert', 'report']
  },
  {
    ...
    files: ['test/e2e/**', 'playwright.config.*', 'docs/parity/**'],
    verbs: ['seed', 'capture', 'mask', 'compare', 'threshold', 'freeze', 'artifact', 'approve', 'diff', 'document']
  },
  {
    ...
    files: ['test/unit/**', 'test/e2e/**', 'vitest.config.js', 'docs/parity/**'],
    verbs: ['delete', 'replace', 'mount', 'import', 'launch', 'assert', 'link', 'classify', 'fail', 'document']
  },
  {
    ...
    files: ['test/unit/*Generated*.spec.js', 'test/unit/**/*Generated*.spec.js', 'docs/parity/**'],
    verbs: ['remove', 'migrate', 'keep', 'replace', 'review', 'tag', 'classify', 'document', 'justify', 'verify']
  },
  {
    ...
    files: ['docs/TAURI_ELECTRON_PARITY_TODO.md', 'docs/parity/generated/**', 'all affected production files'],
    verbs: ['fix', 'verify', 'test', 'commit', 'link', 'log', 'rerun', 'document', 'prioritize', 'close']
  }
]
...
const indexLines = [
  ...
  '',
  `Generated by \`scripts/generate-parity-docs.mjs\`.`,
  '',
...
for (const feature of features) {
  ...
  for (let i = 1; i <= tasksPerFeature; i += 1) {
    ...
    const assertion = assertions[Math.floor((i - 1) / (phases.length * surfaces.length)) % assertions.length]
    ...
    lines.push(`- [ ] ${id} ${verb} ${surface}: ${phase}; inspect \`${file}\`; acceptance: ${assertion}.`)
  }

  lines.push('')
  lines.push('## Completion rule')
  lines.push('')
  lines.push(`Do not close ${feature.prefix} tasks by changing tests only. Each closed item must be linked to a production-code change, a real production import/mount test, or a runtime/visual parity result.`)
  lines.push('')
...
indexLines.push('wc -l docs/parity/generated/*.md docs/parity/index.md')
indexLines.push('```')
indexLines.push('')

fs.writeFileSync(path.join(root, 'docs', 'parity', 'index.md'), `${indexLines.join('\n')}\n`, 'utf8')

const total = features.length * tasksPerFeature
console.log(`Generated ${features.length} feature files with ${total} task lines in ${path.relative(root, outDir)}`)
