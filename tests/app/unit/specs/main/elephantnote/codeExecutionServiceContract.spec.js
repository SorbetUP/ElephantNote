...
describe('physical Code execution service contract', () => {
  ...
  it('keeps execution, status, cancellation and timeout inside the addon package', () => {
    ...
    expect(renderer).toContain("this.api.native.call('execute'")
    expect(renderer).toContain("this.api.native.call('execution.status'")
    expect(renderer).toContain("this.api.native.call('execution.cancel'")
