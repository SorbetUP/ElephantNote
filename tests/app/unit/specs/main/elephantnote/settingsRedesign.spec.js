...
describe('ElephantNote settings redesign', () => {
  ...
  it('mounts optional settings pages only through addon contributions', () => {
    ...
    const providersAddon = read('Elephant/frontend/src/renderer/src/addons/builtin/ai.js')
    ...
    expect(chatAddon).toContain("section: 'ai-chat'")
    expect(searchAddon).toContain("section: 'ai-search'")
    expect(ocrAddon).toContain("section: 'ai-ocr'")
    expect(codeAddon).toContain("section: 'code-execution'")
